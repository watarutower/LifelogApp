...
// */
//// RecyclerViewFundamentalsに引き続き、表示される時間の変更
//fun convertDurationToFormatted(startTimeMilli: Long, endTimeMilli: Long, res: Resources): String {
//    val durationMilli = endTimeMilli - startTimeMilli
//    val timeString = SimpleDateFormat("EEEE MMM-dd-yyyy' Time: 'HH:mm", Locale.getDefault()).format(startTimeMilli)
//
//    val hour = durationMilli / 1000 / 60 / 60
//    val min = (durationMilli - hour * 1000 * 60 * 60) / 1000 / 60
////    val sec = (durationMilli /1000
//
//    return res.getString(R.string.total_time, hour, min, timeString)
//
//}
//
////    val durationMilli = endTimeMilli - startTimeMilli
